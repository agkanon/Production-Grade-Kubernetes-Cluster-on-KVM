...
INSERT INTO measurements (weight_kg, height_cm, age, sex, activity_level, measurement_date) VALUES
(70.5, 175, 25, 'male', 'moderate', NOW() - INTERVAL '10 days'),
(65.2, 162, 30, 'female', 'light', NOW() - INTERVAL '9 days'),
(85.0, 180, 35, 'male', 'active', NOW() - INTERVAL '8 days'),
(58.5, 155, 22, 'female', 'sedentary', NOW() - INTERVAL '7 days'),
(92.3, 185, 40, 'male', 'very_active', NOW() - INTERVAL '6 days'),
(72.0, 168, 28, 'female', 'moderate', NOW() - INTERVAL '5 days'),
(68.5, 172, 26, 'male', 'light', NOW() - INTERVAL '4 days'),
(61.0, 160, 24, 'female', 'moderate', NOW() - INTERVAL '3 days'),
(78.5, 178, 32, 'male', 'active', NOW() - INTERVAL '2 days'),
(55.0, 158, 21, 'female', 'light', NOW() - INTERVAL '1 day');
